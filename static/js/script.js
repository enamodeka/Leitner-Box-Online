...
const ui_btn_delete_card_array = document.querySelectorAll('#ui_btn_delete_card');
...
// if(ui_btn_delete_card_array != null && ui_btn_delete_card_array.length != 0) {
//   alert('not null');
//   ui_btn_delete_card_array.forEach(function(button) {
